...
# 11-22-2022 | Metevier, I. | Added UI controls inside Drive 
#                           | method & initialized in AVI
#============================================================
...
class AVI:
    def __init__(self, DEBUG=False):
        ...
        self.fNN = TFlite_model()
        self.fNN.loadTFliteModel("/home/pi/Desktop/src/tf_lite_model_11_11.tflite")
            ...
            while True:
                if ui.checkOffSwitch():
                   ...
                   # laneLines = self.imgProcessor.extractLines(frame)
                    ...
                    # FIXME: replace with real model
                    frame = self.imgProcessor.frameToHSV(frame)
                    frame = np.array([frame])
                    steeringAngle = int(self.fNN.model_calc_angle(frame))
                    print(int(steeringAngle))
