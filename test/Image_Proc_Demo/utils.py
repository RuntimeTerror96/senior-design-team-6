...
def detect_lines(frame): 
    ...
    cv2.imwrite(filePath + "lab_test_hsv.png",into_hsv) 
    cv2.imwrite(filePath + "lab_test_mask.png",o_mask)
    cv2.imwrite(filePath + "lab_test_orange_detection.png",orange) 
    cv2.imwrite(filePath + "lab_test_line_detected.png",lines) 
